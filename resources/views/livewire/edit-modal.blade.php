<div class="min-w-full align-middle">
    <table class="min-w-full border divide-y divide-gray-200">
        ...
        <tr>
            ...
            <th class="bg-gray-50 px-6 py-3 text-left">
                <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">Preço</span>
            </th>
            <th class="bg-gray-50 px-6 py-3 text-left">
            </th>
        </tr>
...
{{--                    <a !href="#" class="mt-4 rounded-md bg-gray-800 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white hover:bg-gray-700">--}}
        ...
        @empty
            <tr>
                <td class="px-6 py-2 text-sm leading-5 text-gray-900 whitespace-no-wrap" colspan="3">
            ...
            <form wire:submit="update" class="w-full">
                <div class="flex flex-col items-start p-4">
                    <div class="flex w-full items-center border-b pb-4">
                        <div class="text-lg font-medium text-gray-900">Editar Produto</div>
